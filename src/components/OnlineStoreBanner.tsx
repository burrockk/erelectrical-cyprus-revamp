      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="text-white">
            ...
            <p className="text-xl mb-6 text-primary-foreground/90">Tüm aydınlatma ve solar malzemelerimizi online olarak keşfedin. En güncel fiyatlardan anında haberdar olun.</p>
          ...
          <div className="relative">
            <div className="relative z-10 rounded-2xl overflow-hidden shadow-elegant">
              <img src={onlineStoreBanner} alt="Erel Electrical Online Mağaza" className="w-full h-auto" />
            </div>
