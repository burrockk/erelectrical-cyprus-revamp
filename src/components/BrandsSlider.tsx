              ...
              <div key={slideIndex} className="w-full flex-shrink-0">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                  {brands.slice(slideIndex * 4, (slideIndex + 1) * 4).map((brand, index) => (
                    ...
                    >
                       <div className="flex items-center justify-start gap-4 group-hover:scale-105 transition-transform w-full">
                         <div className="w-12 h-12 bg-muted-foreground/20 rounded-md flex-shrink-0 group-hover:bg-white/20 transition-colors"></div>
